...
namespace Puzzles
{
    public partial class GlassDoorProblemsPage1 : Form
    {
        public GlassDoorProblemsPage1()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < heightMapToxAxis.Length; i++)
            {
                strips.Add(new Strip(i, heightMapToxAxis[i]));
            }

            //test1
            List<Strip> output = strips;
        }
    }
